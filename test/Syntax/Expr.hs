...
parses
  ...
  -> IO (My.Expr My.K (P.Vis (Nec Ident) Key))
parses = either
...
fails
  :: ([DefnError] -> Assertion)
  -> E (My.Expr My.K (P.Vis (Nec Ident) Key)) -> Assertion
fails f = either f
...
tests =
  test
    ...
    , "block" ~: 
        ...
        , "reference global" ~: let
            ...
            e = (Block . Defns [] . M.fromList) [
              ...
              (Key (K_ "refMissing"),
                (Closed . toRec . Var . F . F . P.Priv) (Nec Req "global"))
              ]
            in
            parses r >>= assertEqual (banner r) e
        ...
        , "nested tup fields not publicly referencable" ~: let
            ...
            e = (Block . Defns [] . M.fromList) [
              ...
              (Key (K_ "b"), (Closed . toRec . Block . Defns [] . M.fromList) [
                (Key (K_ "f"),
                  (Closed . toRec . Var . F . F . F . F . P.Pub) (K_ "a"))
                ])
              ]
            in parses r >>= assertEqual (banner r) e
        ...
        , "nested tup fields not in private scope" ~: let
            ...
            e = (Block . Defns [] . M.fromList) [
              ...
              (Key (K_ "f"),
                (Closed . toRec . Var . F . F . P.Priv) (Nec Req "g"))
              ]
            in parses r >>= assertEqual (banner r) e
        ...
        , "tup private pun assigns declared variable in private scope to local public field" ~: let
            ...
            e = (Block . Defns [] . M.fromList) [
              (Key (K_ "x"),
                (Closed . toRec . Var . F . F . P.Priv) (Nec Req "x"))
              ]
            in parses r >>= assertEqual (banner r) e
      ...
      , "paths" ~: 
        ...
        , "assign chained access to long path" ~: let
            ...
            e = (Block . Defns [] . M.fromList) [
              (Key (K_ "raba"), 
                (Closed . toRec) ((((Var . F . F . P.Priv) (Nec Req "y1")
                  `At` Key (K_ "a"))
                  `At` Key (K_ "ab"))
                  `At` Key (K_ "aba")))
              ]
        ...
        , "private reference binding when assigning path" ~: let
            ...
            e = (Block . Defns [] . M.fromList) [
              (Key (K_ "a"), (Open . M.fromList) [
                (Key (K_ "f"),
                  (Closed . toRec . Var . F . F . P.Priv) (Nec Req "f"))
                ])
              ]
            in
            parses r >>= assertEqual (banner r) e
        ...
        , "assign private path" ~: let
            ...
            e = Block (Defns [
              (Closed . toRec) ((Var . F . F . P.Priv) (Nec Opt "var")
        ...
        , "assign to distinct parts of a private variable" ~: let
            ...
            e = Block (Defns [
              (Closed . toRec) ((Var . F . F . P.Priv) (Nec Opt "x")
                `Update` (Defns [] . M.fromList) [
    ...
    , "update" ~: let
        ...
        e = (Var . P.Priv) (Nec Req "x")
          `Update` (Defns [] . M.fromList) [
            (Key (K_ "b"),
              (Closed . toRec . Var . F . F . P.Priv) (Nec Req "y"))
            ]
        in
        parses r >>= assertEqual (banner r) e
    ...
    , "destructuring" ~: let
        ...
        e = (Block . Defns [
          -- 0 : "ob"
          (Closed . toRec) ((Var . F . F . P.Priv) (Nec Req "o")
            `At` Key (K_ "b"))
          ] . M.fromList) [
          (Key (K_ "oa"),
            (Closed . toRec) ((Var . F . F . P.Priv) (Nec Req "o")
    ...
    , "destructuring unpack" ~: let
        ...
        e = (Block . Defns [
          ...
          (Key (K_ "ob"), (Closed . toRec)
            ((Var . F . F . P.Priv) (Nec Req "o") `Fix` Key (K_ "a")))
          ]
        in parses r >>= assertEqual (banner r) e
    ...
    , "destructuring unpack with paths" ~: let
        ...
        e = (Block . Defns [
          ...
          (Key (K_ "rem"), (Closed . toRec)
            ((Var . F . F . P.Priv) (Nec Req "get") `Fix` Key (K_ "f")))
          ]
        in parses r >>= assertEqual (banner r) e
    ...
    , "referencing destructured bindings" ~: let
        ...
        e = (Block . Defns [
          -- 0 : "af"
          (Closed . toRec) ((Var . F . F . P.Priv) (Nec Req "a") `At` Key (K_ "f"))
          ] . M.fromList) [
    ...
    , "destructuring with disjoint paths" ~: let
        ...
        e = Block (Defns [
          -- 0 : "a1"
          (Closed . toRec) (((Var . F . F . P.Priv) (Nec Req "a")
            `At` Key (K_ "x"))
            `At` Key (K_ "y")),
          -- 1 : "a2"
          (Closed . toRec) (((Var . F . F . P.Priv) (Nec Req "a")
    ...
    , "destructuring pun public" ~: let
        ...
        e = (Block . Defns [] . M.fromList) [
          (Key (K_ "a"),
            (Closed . toRec) ((Var . F . F . P.Priv) (Nec Req "o") `At` Key (K_ "a")))
          ]
        in parses r >>= assertEqual (banner r) e
    ...
    , "destructuring pun path" ~: let
        ...
        e = Block (Defns [
          (Closed . toRec) ((Var . F . F . P.Priv) (Nec Opt "a")
            `Update` (Defns [] . M.fromList) [
              (Key (K_ "f"), (Open . M.fromList) [
